...
class Config(object):
    ...
    GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "mgleech")
    INDEX_LINK = os.environ.get("INDEX_LINK", "")
    TELEGRAM_LEECH_COMMAND_G = os.environ.get("TELEGRAM_LEECH_COMMAND_G", "mtleech")
    ...
    PYTDL_COMMAND_G = os.environ.get("PYTDL_COMMAND_G", "mpytdl")
